...
INSERT INTO `system_path` VALUES (8, 'AddGroup', '/api/v1/group', 'POST', 'GroupManagement', '新增分组');
INSERT INTO `system_path` VALUES (9, 'UpdateGroup', '/api/v1/group', 'PUT', 'GroupManagement', '修改分组');
INSERT INTO `system_path` VALUES (10, 'UpdateGroupUser', '/api/v1/group/users', 'PUT', 'GroupManagement', '更改分组用户');
INSERT INTO `system_path` VALUES (11, 'UpdateGroupPermission', '/api/v1/group/permissions', 'PUT', 'GroupManagement', '更改分组权限');
INSERT INTO `system_path` VALUES (12, 'DeleteGroup', '/api/v1/group/:id', 'DELETE', 'GroupManagement', '删除分组');
INSERT INTO `system_path` VALUES (13, 'GetGroupList', '/api/v1/groups', 'GET', 'GroupManagement', '获取分组列表');
INSERT INTO `system_path` VALUES (14, 'GetMenuListAll', '/api/v1/menu/list', 'GET', 'GroupManagement', '获取菜单列表');
INSERT INTO `system_path` VALUES (15, 'GetUserListAll', '/api/v1/user/list', 'GET', 'GroupManagement', '获取用户列表');
...
INSERT INTO `system_path` VALUES (24, 'GetSMSRecordList', '/api/v1/audit/sms', 'GET', 'AuditSMSRecord', '获取短信发送记录');
INSERT INTO `system_path` VALUES (25, 'GetLoginRecordList', '/api/v1/audit/login', 'GET', 'AuditLoginRecord', '获取用户登录记录');
INSERT INTO `system_path` VALUES (26, 'GetMenuList', '/api/v1/menus', 'GET', 'MenuManagement', '获取菜单列表');
INSERT INTO `system_path` VALUES (27, 'GetPathList', '/api/v1/paths', 'GET', 'MenuManagement', '获取菜单接口');
